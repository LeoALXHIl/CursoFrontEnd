...
export default function Register() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', background: 'var(--background)' }}>
      <div className="form">
        <h1 style={{ textAlign: 'center', color: 'var(--text-dark)', marginBottom: '20px' }}>Register</h1>
        ...
        <p style={{ textAlign: 'center', marginTop: '15px', color: 'var(--text-light)' }}>
          Already have an account? <a href="/login" style={{ color: 'var(--primary-orange)' }}>Login here</a>
        </p>
      </div>
    </div>
  );
