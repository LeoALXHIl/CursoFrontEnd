...
const Form = ({addTarefa}) => {
    ...
    //função vai criar uma nova tarefa ao ser clicado o botão do submitenviar
...
export default Form;
//componente cria o formulario para inserir uma nova tarefa
//pode ser reutilização do componente da aplicação 
